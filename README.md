...
* Can be used entirely off-line with RTC module and optional GPS module (or known static location) for accurate sun angle measurements and time keeping, or used on-line through enabled on-board WiFi/Ethernet or external ESP-AT WiFi module.
