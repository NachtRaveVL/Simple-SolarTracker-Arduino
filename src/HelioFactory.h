...
//                                                              int8_t pinChannel = -127);     // Pin multiplexer/expander channel number, else -127
    ...
    SharedPtr<HelioRelayMotorActuator> addLinearActuatorRelay(pintype_t outputPinA,         // Digital output pin A (forward) this actuator sits on
                                                              ...
                                                              int8_t pinChannelA = -127,    // Pin multiplexer/expander channel number for Pin A, else -127
                                                              int8_t pinChannelB = -127);   // Pin multiplexer/expander channel number for Pin B, else -127
