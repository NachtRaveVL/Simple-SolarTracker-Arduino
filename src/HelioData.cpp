...
HelioData::HelioData(int8_t idType, int8_t objType, int8_t posIndex, int8_t classType, uint8_t version, uint8_t revision)
...
HelioSubData::HelioSubData(int8_t dataType)
    : type(dataType)
{ ; }
