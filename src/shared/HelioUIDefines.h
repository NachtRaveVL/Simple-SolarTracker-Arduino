...
#define HELIO_UI_STM32_LDTC_ENABLE      false               // Enables STM32/mbed LDTC framebuffer capable StChromaArt canvas in place of default U8g2 canvas (true, note: requires advanced setup), else uses default (false)
