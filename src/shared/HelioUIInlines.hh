...
#endif
    Helio_ST7735Tab tabColor;           // ST7735 tab color (default: undef/-1), if ST7735
...
#endif
                             Helio_ST7735Tab tabColorIn = Helio_ST7735Tab_Undefined)
...
struct TFTDisplaySetup {
    ...
    inline TFTDisplaySetup(Helio_DisplayRotation rotationIn = Helio_DisplayRotation_R0, uint16_t screenWidthIn = TFT_GFX_WIDTH, uint16_t screenHeightIn = TFT_GFX_HEIGHT, pintype_t ledPinIn = -1, Helio_BacklightMode ledModeIn = Helio_BacklightMode_Normal, uint8_t ledBitResIn = DAC_RESOLUTION,
#ifdef ESP32
                           uint8_t ledChannel = 1,
#endif
#ifdef ESP_PLATFORM
