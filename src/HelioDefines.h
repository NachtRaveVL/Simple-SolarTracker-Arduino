...
#if defined(__AVR__)
#define HELIO_SYS_LEAVE_FILES_OPEN          false               // If high access files should be left open to improve performance (true), or closed after use to reduce memory consumption (false)
#else
#define HELIO_SYS_LEAVE_FILES_OPEN          true                // If high access files should be left open to improve performance (true), or closed after use to reduce memory consumption (false)
#endif
